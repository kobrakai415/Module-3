            ...
            <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-4 ">
                ...
                <div class="col">
                    <ul class="navbar-nav mt-2 ">
                        ...
                        <li class="nav">
                            <div class="row ">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    class="bi bi-facebook text-secondary me-2 mr-3" viewBox="0 0 16 16">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    class="bi bi-instagram text-secondary me-2 mr-3" viewBox="0 0 16 16">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    class="bi bi-twitter text-secondary me-2 mr-3" viewBox="0 0 16 16">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    class="bi bi-youtube text-secondary me-2 mr-3" viewBox="0 0 16 16">
                                    <path
                        ...
                        <li class="nav-item mt-3"><button class="btn btn-outline-secondary">Service
                                Code</button></a>
                        </li>
